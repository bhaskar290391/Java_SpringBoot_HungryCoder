...
import com.hungrycoders.service.DoctorService;
...
public class DoctorController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<?> getDoctorById(@PathVariable String id) throws ResourcesNotFoundException {
		try {
	...
	public ResponseEntity<?> getDoctorByEmail(@PathVariable String email) throws ResourcesNotFoundException {
		try {
	...
	@PostMapping
	public ResponseEntity<?> saveDoctor(@Valid @RequestBody com.hungrycoders.payload.request.DoctorPayload doctor)
			throws Exception {
		try {
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> updateDoctor(@Valid @RequestBody com.hungrycoders.payload.request.DoctorPayload doctor,
