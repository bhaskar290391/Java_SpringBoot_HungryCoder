...
import com.hungrycoders.config.JWTUtils;
import com.hungrycoders.config.RouterValidators;
...
public class AuthenticationFilter implements GatewayFilter {
    ...
    private final RouterValidators routerValidator;
    private final JWTUtils jwtUtil;

    @Autowired // Constructor-based dependency injection
    public AuthenticationFilter(RouterValidators routerValidator, JWTUtils jwtUtil) {
